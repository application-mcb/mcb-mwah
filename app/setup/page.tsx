            ...
            try {
              ...
              if (profile) {
                ...
                setFormData({
                  ...
                  previousSchoolMunicipality: profile.previousSchoolMunicipality || '',
                });
                
                // Load municipalities for previous school if province exists
                if (profile.previousSchoolProvince) {
                  try {
                    const municipalitiesData = await getMunicipalitiesByProvince(profile.previousSchoolProvince);
