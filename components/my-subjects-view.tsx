  ...
  if (error) {
    return (
      <div className="space-y-6">
        ...
        <Card className="p-12 text-center border-none bg-blue-50 border-1 shadow-sm border-blue-500">
  ...
  if (enrolledSubjects.length === 0) {
    return (
      <div className="space-y-6">
        ...
        <Card className="p-12 text-center border-none bg-yellow-50 border-1 shadow-sm border-yellow-500">
