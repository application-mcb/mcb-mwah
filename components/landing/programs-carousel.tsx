    ...
    <section id="programs" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p
            className="text-base sm:text-lg text-blue-800/70 max-w-2xl mx-auto font-mono mb-6 sm:mb-8"
            style={{ fontWeight: 300 }}
          >
            Discover our comprehensive range of academic programs designed to
            shape your future.
                        ...
                        <div className="mb-4">
                          <div className="w-14 h-14 bg-white rounded-lg flex items-center justify-center">
                            <GraduationCap
                              size={28}
                              style={{
                                color: getColorValue(program.data.color),
                              }}
                              weight="fill"
                            />
                          </div>
