            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  className={`w-full pl-10 pr-3 py-2 border-1 shadow-xl border-blue-900 rounded-none bg-white text-base shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-900 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm ${errors.gradeId ? 'border-blue-500 focus-visible:ring-blue-500' : ''}`}
                  style={{ fontFamily: 'Poppins', fontWeight: 300 }}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  disabled={loading || isEditing}
                  className={`w-full pl-10 pr-3 py-2 border-1 shadow-xl border-blue-900 rounded-none bg-white text-base shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-900 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm ${errors.courseId ? 'border-blue-500 focus-visible:ring-blue-500' : ''}`}
                  style={{ fontFamily: 'Poppins', fontWeight: 300 }}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                disabled={loading}
                className={`pl-10 border-1 shadow-xl border-blue-900 rounded-none ${errors.sectionName ? 'border-blue-500 focus-visible:ring-blue-500' : ''}`}
                style={{ fontFamily: 'Poppins', fontWeight: 300 }}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                className={`w-full pl-10 pr-3 py-2 border-1 shadow-xl border-blue-900 rounded-none bg-white text-base shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-900 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm ${errors.rank ? 'border-blue-500 focus-visible:ring-blue-500' : ''}`}
                style={{ fontFamily: 'Poppins', fontWeight: 300 }}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                disabled
                className="pl-10 border-1 shadow-xl border-gray-300 bg-gray-100 text-gray-600"
                style={{ fontFamily: 'Poppins', fontWeight: 300 }}
              />
              <BookOpen
                size={18}
