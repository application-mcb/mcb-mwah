...
import { Eye, MagnifyingGlass, Calendar, Phone, MapPin, FileText, User, GraduationCap, Circle, Gear, Clock, ArrowUp, ArrowDown, ArrowClockwise, User as UserIcon, FileText as FileTextIcon, GraduationCap as GraduationCapIcon, X, Printer, Check, Lightning, Trash, Users, BookOpen } from '@phosphor-icons/react';
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 border border-blue-200 p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-blue-700" style={{ fontFamily: 'Poppins', fontWeight: 400 }}>
                      Grade {gradeLevel}
                    </span>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    {uniqueSubjectIds.map((subjectId) => {
                      ...
                      return (
                        ...
                        >
                          <div className={`w-4 h-4 bg-${subject.color} flex-shrink-0`}></div>
                ...
                <div className="space-y-3">
                  <h4 className="text-sm font-medium text-gray-900" style={{ fontFamily: 'Poppins', fontWeight: 400 }}>
                    Subject Sets Breakdown
                  </h4>
                  {gradeSubjectSets.map((subjectSet) => (
                    <div key={subjectSet.id} className="bg-white border border-gray-200 p-4">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h5 className="text-sm font-medium text-gray-900" style={{ fontFamily: 'Poppins', fontWeight: 400 }}>
                          {subjectSet.name}
                        </h5>
                        <span className="text-xs text-gray-500" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                        ...
                        {subjectSet.subjects.map((subjectId) => {
                          ...
                          return (
                            <div key={subjectId} className="text-xs text-gray-700 flex items-center gap-2">
                              <div className={`w-2 h-2 bg-${subject.color} flex-shrink-0`}></div>
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 border border-gray-200 p-4">
            <h4 className="text-sm font-medium text-gray-900 mb-4" style={{ fontFamily: 'Poppins', fontWeight: 400 }}>
              Available Actions
            </h4>
            ...
            <div>
              ...
              <p className="text-2xl font-light text-gray-900" style={{ fontFamily: 'Poppins', fontWeight: 400 }}>
                {enrollments.filter(e => {
                  const grade = parseInt(e.enrollmentInfo?.gradeLevel || '0');
