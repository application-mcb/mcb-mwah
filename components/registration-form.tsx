...
import { Envelope, Lock, Eye, EyeSlash, GoogleLogo } from "@phosphor-icons/react";
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      if (!googleAuthResponse.ok) {
        console.warn('Google authentication failed, but continuing with registration');
      }
        ...
        <div className="space-y-4">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gradient-to-br from-white to-gray-50 text-gray-400 font-medium">Or create with email</span>
            </div>
          </div>
        </div>
