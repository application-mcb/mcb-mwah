    ...
    <div className="space-y-4">
          ...
          {documentToReject && (
            <div className="space-y-2">
              ...
              >
                ...
                {documentTypes[documentToReject.docKey] ||
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: 'Poppins', fontWeight: 400 }}
                  >
                    {documentTypes[documentToApprove.docKey] ||
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: 'Poppins', fontWeight: 400 }}
                  >
                    {documentTypes[documentToRevoke.docKey] ||
      ...
      {selectedDocumentForScan && (
        <DocumentScannerModal
          ...
          documentName={
            documentTypes[selectedDocumentForScan.docKey] ||
