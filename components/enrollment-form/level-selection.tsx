...
import { GraduationCap, User, Check, WarningCircle } from '@phosphor-icons/react'
  ...
  return (
    ...
    >
        ...
        <div>
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Choose whether you're enrolling for high school or college</p>
            </div>
          </div>
        </div>
      ...
      {(() => {
        ...
        const previousEnrollmentLevel = previousEnrollment?.enrollmentInfo?.level
        const studentDepartment = currentEnrollmentLevel || previousEnrollmentLevel

        const showHighSchool = studentDepartment === undefined || studentDepartment === 'high-school'
        const showCollege = studentDepartment === undefined || studentDepartment === 'college'
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <div className="space-y-6 flex flex-col justify-between h-full">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-xl font-medium text-white" style={{ fontFamily: 'Poppins', fontWeight: 500 }}>
                          Continue Previous
                        </h3>
                        <p className="text-sm text-white/80" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                          {previousEnrollment.enrollmentInfo?.courseCode || `Grade ${previousEnrollment.enrollmentInfo?.gradeLevel}`}
                        </p>
                      </div>
                    </div>
                  </div>

                  <p className="text-sm text-white/90" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                    Continue with your previous enrollment information from {previousEnrollment.enrollmentInfo?.schoolYear || 'previous AY'}.
                  </p>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2 text-sm text-white/90">
                      <Check size={16} className="text-white" weight="bold" />
                      <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>Pre-filled information</span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm text-white/90">
                      <Check size={16} className="text-white" weight="bold" />
                      <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                        {previousEnrollment.enrollmentInfo?.level === 'college'
                          ? `Previous: ${previousEnrollment.enrollmentInfo?.semester === 'first-sem' ? 'First' : 'Second'} Semester`
                  ...
                  <div className="pt-4 border-t border-white/20">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-white/90" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                        Click to continue
                      </span>
              ...
              <Card className="group p-8 border-none border-1 shadow-sm bg-gray-50">
                <div className="space-y-6 flex flex-col justify-between h-full items-center justify-center">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-sm text-gray-500" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                      Checking...
                    </span>
                  </div>
                </div>
            ...
            {showHighSchool && (() => {
              ...
              const hasDuration = enrollmentStartPeriodHS && enrollmentEndPeriodHS
              return (
                <Card
                  ...
                  onClick={() => isAvailable && handleLevelSelect('high-school')}
                >
                  <div className="space-y-6 flex flex-col justify-between h-full">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2 text-sm text-white/90">
                        <Check size={16} className="text-white" weight="bold" />
                        <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>Grade-based curriculum</span>
                      </div>
                      <div className="flex items-center space-x-2 text-sm text-white/90">
                        <Check size={16} className="text-white" weight="bold" />
                        <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>Subject sets by grade level</span>
                      </div>
                      <div className="flex items-center space-x-2 text-sm text-white/90">
                        <Check size={16} className="text-white" weight="bold" />
                        <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>Regular/Irregular student options</span>
                      </div>
                    </div>

                    <div className="space-y-2 pt-4 border-t border-white/20">
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-white" style={{ fontFamily: 'Poppins', fontWeight: 400 }}>
                          {hasDuration
                            ? daysRemaining !== null
                              ? isAvailable
                        ...
                        {isAvailable ? (
                          ...
                          <WarningCircle size={20} className="text-white" weight="bold" />
                        )}
                      </div>
                      {isAvailable && hasDuration && daysRemaining !== null && (
                      ...
                      {hasDuration && periodMessage && (
                        <p className="text-xs text-white/70" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                          {periodMessage}
                        </p>
                      )}
                      {!hasDuration && (
            ...
            {showCollege && (() => {
              ...
              const hasDuration = enrollmentStartPeriodCollege && enrollmentEndPeriodCollege
              const hasPreviousCollegeEnrollment = previousEnrollment?.enrollmentInfo?.level === 'college'
              const previousCourse = previousEnrollment?.enrollmentInfo?.courseCode
              return (
                <Card
                  className={`group p-8 border-none border-1 shadow-sm transition-all duration-300 ${
                    isAvailable ? 'hover:shadow-lg cursor-pointer' : 'cursor-not-allowed'
                  ...
                  <div className="space-y-6 flex flex-col justify-between h-full">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="text-xl font-medium text-white" style={{ fontFamily: 'Poppins', fontWeight: 500 }}>
                            {hasPreviousCollegeEnrollment ? 'Shift Course' : 'College'}
                          </h3>
                          <p className="text-sm text-white/80" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                            {hasPreviousCollegeEnrollment ? 'Change Your Program' : 'Degree Programs'}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <p className="text-sm text-white/90" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                      {hasPreviousCollegeEnrollment
                        ? `You are currently enrolled in ${previousCourse || 'a course'}. Select this option to shift to a different degree program.`
                    ...
                    <div className="space-y-2">
                      {hasPreviousCollegeEnrollment ? (
                        <>
                          <div className="flex items-center space-x-2 text-sm text-white/90">
                            <Check size={16} className="text-white" weight="bold" />
                            <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>Transfer to a different course</span>
                          </div>
                          <div className="flex items-center space-x-2 text-sm text-white/90">
                            <Check size={16} className="text-white" weight="bold" />
                            <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>Maintain your academic progress</span>
                          </div>
                          <div className="flex items-center space-x-2 text-sm text-white/90">
                            <Check size={16} className="text-white" weight="bold" />
                            <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>Subject selection by new course</span>
                          </div>
                        </>
                      ) : (
                        <>
                          <div className="flex items-center space-x-2 text-sm text-white/90">
                            <Check size={16} className="text-white" weight="bold" />
                            <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>Course-based curriculum</span>
                          </div>
                          <div className="flex items-center space-x-2 text-sm text-white/90">
                            <Check size={16} className="text-white" weight="bold" />
                            <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>Degree program enrollment</span>
                          </div>
                          <div className="flex items-center space-x-2 text-sm text-white/90">
                            <Check size={16} className="text-white" weight="bold" />
                            <span style={{ fontFamily: 'Poppins', fontWeight: 300 }}>Subject selection by course</span>
                          </div>
                        </>
                      )}
                    </div>
