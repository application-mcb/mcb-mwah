...
export default function TeacherGradesView({ teacherId }: TeacherGradesViewProps) {
  ...
  const calculateAverage = (grades: SubjectGrade, isCollege: boolean = false): number | null => {
    ...
    if (isCollege) {
      ...
      validGrades = [grades.period1, grades.period2, grades.period3]
        .filter(grade => grade !== null && grade !== undefined) as number[];
    } else {
      // High School: use all 4 periods
      validGrades = [grades.period1, grades.period2, grades.period3, grades.period4]
        .filter(grade => grade !== null && grade !== undefined) as number[];
    }
  ...
  const handleSpecialStatusChange = (subjectId: string, status: 'INC' | 'FA' | 'FW' | 'W' | null) => {
    setEditedGrades(prev => ({
      ...prev,
      [subjectId]: {
        ...prev[subjectId],
        specialStatus: status === prev[subjectId]?.specialStatus ? null : status
      }
    }));
  };
                ...
                <>
                  ...
                  <div className="space-y-4">
                    {teacherSubjects.map((subject) => {
                      ...
                      const currentGrades = studentGrades[editingStudent]?.[subject.id] || {};
                      ...
                      const gridCols = isCollege ? 'grid-cols-4' : 'grid-cols-5';
                      ...
                      return (
                        <Card key={subject.id} className="p-4">
                            ...
                            <div>
                              ...
                              <div className="px-3 py-2 bg-gray-100 text-center">
                                {subjectGrades.specialStatus ? (
                                  <div className="text-xs font-medium text-gray-900 uppercase" style={{ fontFamily: 'Poppins', fontWeight: 400 }}>
                                    {subjectGrades.specialStatus}
                                  </div>
                                ) : (
                                  <>
                                    {(() => {
                                      const avg = calculateAverage(subjectGrades, isCollege);
                                      const numericMode = avg !== null ? convertToNumericMode(avg) : null;
                                      
                                      return avg !== null && numericMode !== null ? (
                                        <>
                                          <div className="text-xs font-medium text-gray-900" style={{ fontFamily: 'Poppins', fontWeight: 400 }}>
                                            {avg.toFixed(1)}
                                          </div>
                                          <div className="text-xs font-mono text-gray-600 mt-1" style={{ fontFamily: 'Poppins', fontWeight: 400 }}>
                                            ({numericMode.toFixed(2)})
                                          </div>
                                          <div className="text-xs text-gray-600 mt-1" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                          ...
                          <div className="mt-4 pt-4 border-t border-gray-200">
                            <label className="block text-xs font-medium text-gray-700 mb-2" style={{ fontFamily: 'Poppins', fontWeight: 400 }}>
                              Special Status
                            </label>
                            <div className="flex gap-2 flex-wrap">
                              <button
                                type="button"
                                onClick={() => handleSpecialStatusChange(subject.id, 'INC')}
                              ...
                              <button
                                type="button"
                                onClick={() => handleSpecialStatusChange(subject.id, 'FA')}
                                className={`px-3 py-1.5 text-xs font-medium transition-colors ${
                              ...
                              <button
                                type="button"
                                onClick={() => handleSpecialStatusChange(subject.id, 'FW')}
                                className={`px-3 py-1.5 text-xs font-medium transition-colors ${
                              ...
                              <button
                                type="button"
                                onClick={() => handleSpecialStatusChange(subject.id, 'W')}
                                className={`px-3 py-1.5 text-xs font-medium transition-colors ${
                              ...
                              {subjectGrades.specialStatus && (
                                <button
                                  type="button"
                                  onClick={() => handleSpecialStatusChange(subject.id, null)}
                            ...
                            <p className="text-xs text-gray-500 mt-2" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                              INC: Incomplete | FA: Failed (Absent) | FW: Failed (Withdrawn) | W: Withdrawn
                            </p>
                          </div>
                        </Card>
                      );
