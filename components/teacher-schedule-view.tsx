...
import { GraduationCap, BookOpen, Users, Clock, Calendar } from '@phosphor-icons/react';
...
export default function TeacherScheduleView({ teacherId }: TeacherScheduleViewProps) {
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'].map((day, index) => (
            <Card key={day} className="p-6 border-none bg-gray-50 border-1 shadow-sm border-blue-900">
      ...
      <div className="space-y-6">
        ...
        <Card className="p-12 text-center border-none bg-gray-50 border-1 shadow-sm border-blue-900">
          ...
          <p
            ...
            style={{ fontFamily: 'Poppins', fontWeight: 300 }}
          >
            Your teaching schedule will be available once your class assignments are configured and a schedule has been created.
          </p>
        </Card>
      </div>
    );
            ...
            <div className="space-y-3">
              {scheduleByDay[day]?.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    <div
                      ...
                      style={{ backgroundColor: getSubjectColor(item.subject.color) }}
                    ></div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      <div
                        ...
                        style={{ backgroundColor: getGradeColor(item.grade.color) }}
                      ></div>
                      <span className="text-xs text-gray-600"
                            style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
                ...
                <div className="text-center py-8 text-gray-400">
                  <Calendar size={32} className="mx-auto mb-2" weight="duotone" />
                  <p className="text-xs" style={{ fontFamily: 'Poppins', fontWeight: 300 }}>
