...
export const Modal = ({ isOpen, onClose, title, children, size = "lg" }: ModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-blue-900/50 backdrop-blur-sm">
      ...
      {/* Modal Content */}
      <div className={`relative bg-white rounded-lg shadow-xl w-full ${sizeClasses[size]} max-h-[90vh] overflow-hidden transform transition-all duration-300 ease-in-out ${
        isAnimating 
