...
import { GradePrintContent } from './grade-print-content'
import type { ChartDataPoint } from '../types'

interface GradePrintControlsProps {
...
export const GradePrintControls: React.FC<GradePrintControlsProps> = ({
  gradeChartData,
  insight,
  forecast,
  registrarName,
    ...
    <>
      ...
      {isPrintOpen && hasAnySection && (
        <Print
          ...
          title="Students by Grade Level Analytics"
        >
          <GradePrintContent
